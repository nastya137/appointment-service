...
Fullstack project: клиент выбирает специалиста, услугу и свободное время, оставляет контакт и создаёт запись — через адаптивный веб-интерфейс или Telegram-бота.
...
![Desktop-интерфейс сервиса онлайн-записи](docs/interface.png)
